...
.info_title{font-weight:bold;width:70px;}
...
<div id="box">
    ...
    <div id="cp_btn">
        <button class="layui-btn layui-btn-primary" onclick="window.location='<?php echo ($_GET[root_dir]); ?>/index.php/Home/Chanpin/index'"><i class="fa fa-arrow-left" aria-hidden="true"></i>返回</button>
