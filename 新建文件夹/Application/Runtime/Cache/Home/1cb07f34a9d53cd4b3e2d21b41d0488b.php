...
<html>
	...
	window.rootdir='<?php echo ($_GET[root_dir]); ?>';
	</script>
	<body>
		<div class="layui-layout layui-layout-admin">
				...
				<div class="layui-main">
					<div class="admin-login-box">
						<a class="logo" style="left: 0;" href="http://beginner.zhengjinfan.cn/demo/beginner_admin/">
							<span style="font-size: 22px;">中软远景—设置</span>
						</a>
					...
					<ul class="layui-nav admin-header-item">
						...
						<li class="layui-nav-item">
							<a href="<?php echo ($_GET['root_dir']); ?>">返回主页</a>
						...
						<li class="layui-nav-item">
							<a href="javascript:;" class="admin-header-user" style="width:100px;">
								...
								<span style="width:100px;"><center><b>admin</b></center></span>
							</a>
							<dl class="layui-nav-child">
				...
				<div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
					...
					<div class="layui-tab-content" style="min-height: 150px; padding: 5px 0 0 0;">
						<div class="layui-tab-item layui-show">
							<iframe src="<?php echo ($_GET['root_dir']); ?>/index.php/Home/Option/optioncenter"></iframe>
						</div>
					</div>
			...
			<script type="text/javascript" src="<?php echo ($_GET['public_dir']); ?>/index_js_css/datas/nav-option.js"></script>
			<script>
				layui.config({
	...
	shadeMobile.on('click', function() {
		$('body').removeClass('site-mobile');
			...
			<script src="<?php echo ($_GET['public_dir']); ?>/index_js_css/js/index.js"></script>
