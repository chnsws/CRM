...
<!--end!!-->
		...
		.anniu{width:auto;height:59px;border:1px solid #ccc;margin-left:13px;} 
		...
		.anniudw a{  position: relative; margin-left: 30px;}
			...
			#sxdiv{background-color:#fff;margin:0px 0px 0px 10px;padding:-10px 5px 0px 5px;}
 ...
 <!--<script>
	...
	<body style="position:relative">
		...
		<div>
			  <ul>
			    <li class="panel-heading"><span class="panel-title">客户信息</span><span class="xinzeng2"><button  onclick="add_yh()" class=" layui-btn layui-btn-small">新增用户</button><span><button onclick="daoru()" style="margin-left:20px" class=" layui-btn layui-btn-small">导入客户</button></span></li>
			  ...
			  <!--	<div class="peizhi">
				   	<div class="left">
					   	 ...
					   	 <div  class="left1" style="margin-top:13px;margin-bottom:13px;line-height:30px" >
					   	 	 	<?php echo ($new_html); ?>					
						</div>
        ...
        <div id="sxshowbtn" onselectstart='return false'><i class='fa fa-chevron-up' aria-hidden='true'></i></div>
				...
				<div id="dialog-form" style="display: none;border:1px"> <!--新增商机 弹出框-->
