...
<head>
    ...
    <script src="<?php echo ($_GET['public_dir']); ?>/uikit/js/uikit.min.js"></script>
     <link rel="stylesheet" href="<?php echo ($_GET['public_dir']); ?>/uikit/css/components/accordion.css" />
...
<table id="hid_table">
    <tr>
        ...
        <td><input type="text" placeholder="请填写显示名称，最长20个字符" id="newzdname" class="layui-input"/></td>
    </tr>
    <!--
    <tr>
        ...
        if(pageid=='paixu_chanpin')
        {
            $.post(root_dir+"/index.php/Home/YewuziduanDo/zd_for_chanpin",function(res){
                setTimeout(function() {
                    ...
                    $.getScript("<?php echo ($_GET['public_dir']); ?>/uikit/js/components/accordion.js");
