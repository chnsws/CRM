...
<div id="box">
    ...
    <div id="chart"></div>
    <div id="table">
        <div class="table_head">商机数: <?php echo ($zong_num); ?>， 预计销售金额：¥ <?php echo ($zong_sum); ?> ， 概率金额：¥ <?php echo ($zong_sum_gailv); ?></div>
        ...
        series : [
            {
                name:'预计销售金额',
                type:'bar',
                data:<?php echo ($chart_sum); ?>,
                yAxisIndex:1
            },
            {
                name:'概率金额',
                type:'bar',
                data:<?php echo ($chart_sum_gl); ?>,
                yAxisIndex:1
            },
            {
                name:'商机数',
                type:'line',
                data:<?php echo ($chart_num); ?>,
                yAxisIndex:0
            }
        ]
    };
