...
$(function(){
    if("<?php echo ($_GET['mod']); ?>"!='')
    {
        $("#feedback_mod").find("option[value='"+"<?php echo ($_GET['mod']); ?>"+"']").prop("selected",true);
    }
    if("<?php echo ($_GET['type']); ?>"!='')
    {
        $("#feedback_type").find("option[value='"+"<?php echo ($_GET['type']); ?>"+"']").prop("selected",true);
    }
    if("<?php echo ($_GET['act']); ?>"!='')
    {
        $("#feedback_act").find("option[value='"+"<?php echo ($_GET['act']); ?>"+"']").prop("selected",true);
    }
    ...
    $("#feedback_mod").change(function(){
        window.location=rooturl+"/index.php/Home/Fankui/fk_list?mod="+$(this).val()+"&type="+"<?php echo ($_GET['type']); ?>"+"&act="+"<?php echo ($_GET['act']); ?>";
    });
    $("#feedback_type").change(function(){
        window.location=rooturl+"/index.php/Home/Fankui/fk_list?mod="+"<?php echo ($_GET['mod']); ?>"+"&type="+$(this).val()+"&act="+"<?php echo ($_GET['act']); ?>";
    });
    $("#feedback_act").change(function(){
        window.location=rooturl+"/index.php/Home/Fankui/fk_list?mod="+"<?php echo ($_GET['mod']); ?>"+"&type="+"<?php echo ($_GET['type']); ?>"+"&act="+$(this).val();
    });
});
