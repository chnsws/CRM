...
class MainController extends DBController {
    ...
    public function index(){
        ...
        if($zhidingnum)
        {
            ...
            {
                $gonggaostr.='<div><span class="gonggao_row_title"><a href="'.$_GET['root_dir'].'/index.php/Home/Option/gonggaomore?ggid='.$v['ggsz_id'].'&from=main2">'.$v['ggsz_name'].'</a></span><span class="zhiding">置顶</span><span class="gonggao_row_time">'.$v['ggsz_fbsj'].'</span></div>';
            }
            if($zhidingnum<7)
            {
                ...
                foreach($buzhiding as $v)
                {
                    ...
                    $buzhidingnum--;
                    $gonggaostr.='<div><span class="gonggao_row_title"><a href="'.$_GET['root_dir'].'/index.php/Home/Option/gonggaomore?ggid='.$v['ggsz_id'].'&from=main2">'.$v['ggsz_name'].'</a></span><span class="gonggao_row_time">'.$v['ggsz_fbsj'].'</span></div>';
                }
            }
        }
        else
